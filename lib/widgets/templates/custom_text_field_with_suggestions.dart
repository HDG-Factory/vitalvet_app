...
class CustomTextFieldWithSuggestions extends StatefulWidget {
  ...
  @override
  State<CustomTextFieldWithSuggestions> createState() =>
      _CustomTextFieldWithSuggestionsState(
          fieldController,
          suggestions,
          suggestionBuilder,
          actions,
...
class _CustomTextFieldWithSuggestionsState
    extends State<CustomTextFieldWithSuggestions> {
      ...
      child: TypeAheadField(
            ...
            : (pattern) {
                ...
                if (suggestions != null) {
                  if (suggestions![0] is String) {
                    returnedList.addAll(suggestions!.where((suggestion) =>
                        suggestion
                            .toLowerCase()
        ...
        textFieldConfiguration: TextFieldConfiguration(
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor: (onSuggestionSelectedFillColor != null &&
                    showSuggestionFillColor)
                ? onSuggestionSelectedFillColor
            ...
            suffixIcon: (onSuggestionSelectedFillColor != null &&
                    showSuggestionFillColor)
