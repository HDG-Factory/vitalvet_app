...
class _RegisterScreenState extends State<RegisterScreen> {
            ...
            [
                      ...
                      if (pointerSignal.scrollDelta.dy > 0) {
                        if (formKey.currentState!.validate()) {
                          ...
                          pageController.nextPage(
                              curve: curve, duration: animationDuration);
                          setState(() {
              ...
              if (currentIndex > 0)
                Row(
                  ...
                  children:
                      List<Widget>.generate(registerSteps.length, (int index) {
                    return Padding(
  ...
  Align _mainColumn(BuildContext context, List<Widget> children) {
    return Align(
      alignment:
          (isMediumOrMoreScreen) ? Alignment.centerLeft : Alignment.center,
      child: SizedBox(
  ...
  Widget _registerBtn(BuildContext context) {
    return LoginRegisterBtn(
      text: (currentIndex == 0 || currentIndex == maxIndex)
          ? 'Registrarse'
          : 'Siguiente',
      onPressed: () {
        if (formKey.currentState!.validate()) {
