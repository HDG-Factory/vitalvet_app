        ...
        child: Column(
          ...
          children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Navigator.pushNamed(context, '$HOME_ROUTE/$PETS_LIST_VIEW_ROUTE/$PET_MEDICAL_HISTORY_VIEW_ROUTE');
                              },
            ...
            Padding(
              ...
              child: SizedBox(
                height: 94.78.hb - 200,
                child: GridView.count(childAspectRatio: 2, mainAxisSpacing: 10.0, crossAxisSpacing: 10.0, crossAxisCount: 4, children: [
                  ...List.generate(
                    12,
                    (index) => Container(
