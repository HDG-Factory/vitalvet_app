...
class PetMedicalAttentionView extends StatefulWidget {
  ...
  @override
  State<PetMedicalAttentionView> createState() => _PetMedicalAttentionViewState();
}
...
class _PetMedicalAttentionViewState extends State<PetMedicalAttentionView> {
  ...
  void _initState(context) {
    ...
    BlocProvider.of<TitleBarBloc>(context).add(ChangeTitleBarEvent(onPressed: () {}));
                                ...
                                children: [
                                  Expanded(
                                    child: CustomTextField(
                                      ...
                                      labelText: 'Nombre de medicina o tratamiento',
                                    ),
                                  ),
