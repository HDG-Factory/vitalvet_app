...
import 'package:vitalvet_app/ui/widgets/owner_dialogs/owner_dialog.dart';
...
class EditOwnerDialog extends StatelessWidget {
  ...
  EditOwnerDialog({Key? key, required this.ownerId, required this.editOwnerBloc}) : super(key: key);
