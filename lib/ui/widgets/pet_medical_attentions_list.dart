...
import 'package:vitalvet_app/ui/widgets/templates/list_viewer.dart';
    ...
    return BlocBuilder<PetsListBloc, PetsListState>(
      builder: (context, state) {
        ...
        return ListViewer(
          items: pets,
          onItemTap: (item) {
            Navigator.pushNamed(context, '$HOME_ROUTE/$PETS_LIST_VIEW_ROUTE/$PET_MEDICAL_ATTENTION_VIEW_ROUTE');
          },
