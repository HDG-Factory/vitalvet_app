...
import 'package:vitalvet_app/ui/widgets/templates/custom_screen.dart';
import 'package:vitalvet_app/utils/screen_size.dart';
import 'package:vitalvet_app/ui/widgets/app_icon_svg.dart';
                ...
                Padding(
                  ...
                  child: AspectRatio(
                    ...
                    child: Container(
                      ...
                      child: CustomPaint(
                        painter: AppIconSvg(),
                        size: Size(MediaQuery.of(context).size.width, (MediaQuery.of(context).size.width * 0.9941860465116279).toDouble()),
                      ),
                    ),
                  ),
                ),
